...
class CoTDataset(Dataset):
    def __init__(self, tokenizer, file_path, max_length):
        ...
        batch_encoding = tokenizer(edited_sents, add_special_tokens=True, truncation=True, max_length=max_length)
