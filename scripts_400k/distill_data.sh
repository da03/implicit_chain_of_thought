export I=0
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/400k_baselines/cot_nobrackets/gptmedium/checkpoint_6_5e-05_gpt2-medium
export EPOCHS=1
export LR=5e-5
export BSZ=32
export BEAM=1
export FOLDER=nobrackets_400kaugmented_math_scaffolding_formula_$I
export MODELSAVE="${MODEL////_}"
export SAVE=data/distilled_nobrackets_400kaugmented_math_scaffolding_formula_cot_gpt2-medium_repharvard_100k_beam${BEAM}_${I}
echo $SAVE
mkdir $SAVE
