...
export QMODEL=autoregressive_sharps_augmented_model_scaffolding_formula_phase1_inter_Fdiagonal_gpt2_fixed_e30_legacy_2_mgpt2_try1_7_repharvard_interval${INTERVAL}/checkpoint_${QCKPTEPOCH}_5e-05
export BSZ=32
export A=1
