...
def main(output_dir, model, temperature, max_tokens, seed, num_shot, num_prompts):
    random.seed(seed)
    ...
    if WRITE_RESULTS:
        ...
        output_filename = os.path.join(output_dir, 'generated.jsonl')
