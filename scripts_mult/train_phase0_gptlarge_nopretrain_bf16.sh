...
export SAVE=model_phase0_${D}_inter_gptlarge_nopretrain
mkdir $SAVE
...
export FOLDER=long_mult_${D}_inter
export QMODEL=gpt2-large
export SAVE=model_phase0_${D}_inter_gptlarge_nopretrain_bf16
mkdir $SAVE
CUDA_VISIBLE_DEVICES=3 stdbuf -oL -eL python train_phase0_bf16.py \
    --train_path data/${FOLDER}/src1_train.txt \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_test.txt \
    --epochs $EPOCHS \
