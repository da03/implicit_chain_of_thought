...
def main():
    ...
    for epoch in range(args.epochs):
        #save_model(model, mlps, tokenizer, f'models_mimic_fixq_feedp_gptsmall_{args.mode}_{args.model}_multmlp/checkpoint_{epoch}_{args.lr}')
        ...
        for batch in tqdm.tqdm(train_dataloader):
            ...
            for z, zp, sigma_i, mlp in zip(zs_q, zs_p, sigmas, mlps):
                ...
                item = ((z-mlp(zp))*(z-mlp(zp))).sum() / sigma_i / sigma_i / 2 / total
