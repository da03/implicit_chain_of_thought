...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/augmented_model_phase1_scaffolding_formula_inter_Fdiagonal_gpt2large_fixed_e40_qe7_nolegacy_try1/checkpoint_4_5e-05
export BSZ=32
export A=1
export SAVE=augmented_model_phase2_${D}_inter_pgpt2${CKPTEPOCH}_qgpt2${QCKPTEPOCH}_postphase0_fixq_initmodel_opt_bsz${BSZ}_nolegacy_e${EPOCHS}_try1_nolegacybest
mkdir $SAVE
