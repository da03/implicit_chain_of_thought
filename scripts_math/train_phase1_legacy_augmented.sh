...
export AMODEL=augmented_model_${D}_phase0_inter_fixq_qgpt2_p${MODELSAVE}_r0_mbottom_e15_f${F}_opt_${CKPT}/checkpoint_${CKPTEPOCH}_5e-05
export SAVE=augmented_model_${D}_phase1_inter_F${F}_gpt2_fixed_e${EPOCHS}_legacy_${CKPTEPOCH}_m${MODELSAVE}_try1_${CKPT}
mkdir $SAVE
