...
export FOLDER=sharps_200kaugmented_math_${D}
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200k/phase0/interval0/nornn/gptmedium/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200k/phase1/nolegacy_origfeedp/origdata/interval0/gptmedium/m1/lr5e-5_minus0_fdiagonal/checkpoint_12_5e-05
export BSZ=32
export A=1
export SAVE=200k/phase2/nolegacy/origdata/gptmedium/m1/interval0/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq
mkdir -p $SAVE
#TODO: use normgrad
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=2 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_origfeedp.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --epochs $EPOCHS \
