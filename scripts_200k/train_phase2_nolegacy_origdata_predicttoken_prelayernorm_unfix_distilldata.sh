...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/distilldata/interval2/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_29_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/distilldata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt29_unfix
mkdir -p $SAVE
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval1/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_3_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/distilldata/interval1/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_29_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/distilldata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt29_unfix
mkdir -p $SAVE
...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/distilldata/interval0/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_29_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/distilldata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt29_unfix
mkdir -p $SAVE
...
#export FOLDER=sharps_distilled_200kaugmented_math_scaffolding_formula_cot_gpt2_repharvard_100k_beam1
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval1/nornn/gptmedium/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/1rnn_predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/distilldata/interval1/gptmedium/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_8_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/distilldata/gptmedium/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt8_unfix
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm_unfix.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/sharps_200kaugmented_math_scaffolding_formula/src1_valid.txt \
...
#export FOLDER=sharps_distilled_200kaugmented_math_scaffolding_formula_cot_gpt2_repharvard_100k_beam1
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval0/nornn/gptmedium/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/1rnn_predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/distilldata/interval${INTERVAL}/gptmedium/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_8_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/distilldata/gptmedium/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt8_unfix
mkdir -p $SAVE
...
#export FOLDER=sharps_distilled_200kaugmented_math_scaffolding_formula_cot_gpt2_repharvard_100k_beam1
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptmedium/r0_mbottom_e10_fdiagonal_minus0/checkpoint_3_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/1rnn_predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/distilldata/interval${INTERVAL}/gptmedium/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_8_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/distilldata/gptmedium/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt8_unfix
