...
### Sep 18
# phase 1, legacy, orig data, gptsmall, interval 0, m1, feedp, use argmin 
export LR=5e-5
export W=0
export MINUS=0
export PW=0
...
export AMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200k/phase0/interval0/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export SAVE=200k/phase1/legacy/origdata/interval${INTERVAL}/gptsmall/m${M}/feed${FEED}_use${USE}_lr${LR}_w${W}_pw${PW}_minus${MINUS}_f${F}
mkdir -p $SAVE
CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=false stdbuf -oL -eL python train_phase1_fixed_math_interval_autoregressive_addmlp_rnn_mixture_learnp_feedp_fixnorm_legacy.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --epochs $EPOCHS \
...
# phase 1, legacy, orig data, gptmedium, interval 0, m1, feedp, use argmin 
export LR=5e-5
export W=0
export MINUS=0
export PW=0
...
export AMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200k/phase0/interval0/nornn/gptmedium/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export SAVE=200k/phase1/legacy/origdata/interval${INTERVAL}/gptmedium/m${M}/feed${FEED}_use${USE}_lr${LR}_w${W}_pw${PW}_minus${MINUS}_f${F}
mkdir -p $SAVE
CUDA_VISIBLE_DEVICES=1 TOKENIZERS_PARALLELISM=false stdbuf -oL -eL python train_phase1_fixed_math_interval_autoregressive_addmlp_rnn_mixture_learnp_feedp_fixnorm_legacy.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
...
# phase 1, legacy, orig data, gptmedium, interval 0, m1, feedq, use gt
export LR=5e-5
export W=0
export MINUS=0
export PW=0
