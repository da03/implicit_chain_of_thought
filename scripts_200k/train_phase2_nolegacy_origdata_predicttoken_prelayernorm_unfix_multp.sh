...
export BSZ=32
export A=1
export SAVE=multp_fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt29_unfix
mkdir -p $SAVE
