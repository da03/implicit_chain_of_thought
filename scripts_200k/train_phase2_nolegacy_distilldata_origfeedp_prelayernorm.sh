...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/distilldata/interval0/gptsmall/m1/lr5e-5_minus0_fdiagonal/checkpoint_7_5e-05
export BSZ=32
export A=1
export ADD=0
export SAVE=200kprelayernorm/phase2/nolegacy/distilldata/gptsmall/m1/interval0/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_origfeedp_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/sharps_200kaugmented_math_scaffolding_formula/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --valtest_path data/sharps_200kaugmented_math_scaffolding_formula/src1_train.txt.1000 \
    --epochs $EPOCHS \
    --lr $LR \
    --model $MODEL \
    --additional_norm $ADD \
...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/distilldata/interval0/gptmedium/m1/lr5e-5_minus0_fdiagonal/checkpoint_7_5e-05
export BSZ=32
export A=1
export ADD=0
export SAVE=200kprelayernorm/phase2/nolegacy/distilldata/gptmedium/m1/interval0/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_origfeedp_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/sharps_200kaugmented_math_scaffolding_formula/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --valtest_path data/sharps_200kaugmented_math_scaffolding_formula/src1_train.txt.1000 \
...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/distilldata/interval1/gptmedium/m1/lr5e-5_minus0_fdiagonal/checkpoint_27_5e-05
export BSZ=32
export A=1
export ADD=0
export SAVE=200kprelayernorm/phase2/nolegacy/distilldata/gptmedium/m1/interval${INTERVAL}/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=2 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_origfeedp_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/sharps_200kaugmented_math_scaffolding_formula/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --valtest_path data/sharps_200kaugmented_math_scaffolding_formula/src1_train.txt.1000 \
...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/distilldata/interval2/gptmedium/m1/lr5e-5_minus0_fdiagonal/checkpoint_9_5e-05
export BSZ=32
export A=1
export ADD=0
export SAVE=200kprelayernorm/phase2/nolegacy/distilldata/gptmedium/m1/interval${INTERVAL}/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=3 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_origfeedp_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/sharps_200kaugmented_math_scaffolding_formula/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --valtest_path data/sharps_200kaugmented_math_scaffolding_formula/src1_train.txt.1000 \
