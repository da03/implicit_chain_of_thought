...
export BSZ=32
export A=1
export SAVE=200k/phase2/nolegacy/origdata/gptmall/m1/interval0/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=2 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --epochs $EPOCHS \
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200k/phase0/interval0/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200k/phase1/nolegacy/origdata/interval0/gptsmall/m1/feedq_usegt_lr5e-5_w0_pw0_minus0_fdiagonal/checkpoint_18_5e-05
export BSZ=32
export A=1
export SAVE=200k/phase2/nolegacy/origdata/gptmall/m1/interval0/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_qgpt
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --epochs $EPOCHS \
    ...
    --val_path data/${FOLDER}/src1_valid.txt \
    --val_path data/${FOLDER}/src1_train.txt.1000 \
...
export FOLDER=sharps_200kaugmented_math_${D}
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval2/gptsmall/m1/feedq_usegt_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_33_5e-05
export BSZ=32
export A=1
export SAVE=predicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval0/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --epochs $EPOCHS \
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval2/gptsmall/m1/feedq_usegt_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_9_5e-05
export BSZ=32
export A=1
export SAVE=predicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval0/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt9
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=3 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --epochs $EPOCHS \
...
export FOLDER=sharps_200kaugmented_math_${D}
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval1/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_3_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval1/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_16_5e-05
export BSZ=32
export A=1
export SAVE=predicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval1/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt16
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=2 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval2/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_21_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt21_unfix
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm_unfix.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --eval_path data/${FOLDER}/src1_train.txt.1000plussub1000 \
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval2/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_9_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt9_unfix
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=1 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm_unfix.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --eval_path data/${FOLDER}/src1_train.txt.1000plussub1000 \
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval2/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_39_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt39_unfix
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=2 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm_unfix.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --eval_path data/${FOLDER}/src1_train.txt.1000plussub1000 \
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval2/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_29_5e-05
export BSZ=32
export A=1
export T=1
export SAVE=softmaxp_fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt29_unfix_t${T}
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm_unfix.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval1/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_3_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval1/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_29_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt29_unfix
mkdir -p $SAVE
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=3 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_normgrad_predicttoken_prelayernorm_unfix.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
    --val_path data/${FOLDER}/src1_valid.txt \
    --test_path data/${FOLDER}/src1_train.txt.1000 \
    --eval_path data/${FOLDER}/src1_train.txt.1000plussub1000 \
...
export FOLDER=sharps_200kaugmented_math_${D}
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval0/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval0/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_29_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt29_unfix
mkdir -p $SAVE
