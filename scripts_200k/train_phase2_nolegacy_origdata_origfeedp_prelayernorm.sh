...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/origdata/interval0/gptsmall/m1/lr5e-5_minus0_fdiagonal/checkpoint_10_5e-05
export BSZ=32
export A=1
export ADD=1
export SAVE=200kprelayernorm/phase2/nolegacy/origdata/gptsmall/m1/interval0/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_add$ADD
mkdir -p $SAVE
#TODO: use normgrad
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval0/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/origdata/interval0/gptsmall/m1/lr5e-5_minus0_fdiagonal/checkpoint_57_5e-05
export BSZ=32
export A=1
export ADD=0
export SAVE=200kprelayernorm/phase2/nolegacy/origdata/gptsmall/m1/interval0/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_add${ADD}_latest57
mkdir -p $SAVE
#TODO: use normgrad
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval0/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/origdata/interval0/gptsmall/m1/lr5e-5_minus0_fdiagonal/checkpoint_19_5e-05
export BSZ=32
export A=1
export ADD=0
export SAVE=200kprelayernorm/phase2/nolegacy/origdata/gptsmall/m1/interval0/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_add${ADD}_latest19
mkdir -p $SAVE
#TODO: use normgrad
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval0/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase1/nolegacy_origfeedp/origdata/interval0/gptsmall/m1/lr5e-5_minus0_fdiagonal/checkpoint_0_5e-05
export BSZ=32
export A=1
export ADD=0
export SAVE=200kprelayernorm/phase2/nolegacy/origdata/gptsmall/m1/interval0/nornn/orig_feedp/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_add${ADD}_latest0
mkdir -p $SAVE
#TODO: use normgrad
TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=3 stdbuf -oL -eL python train_phase2_patchmlp_fixed_legacy_math_autoregressive_addmlp_nolegacy_rnn_mixture_learnp_feedp_nornn_origfeedp_prelayernorm.py \
    --train_path data/${FOLDER}/src1_train.txt.1000plus \
