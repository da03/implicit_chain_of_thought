...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval2/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_2_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/0rnn_predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval2/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_16_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt16_unfix_0rnn
mkdir -p $SAVE
...
export F=diagonal
export MODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/200kprelayernorm/phase0/interval1/nornn/gptsmall/r0_mbottom_e10_fdiagonal_minus0/checkpoint_3_5e-05
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/0rnn_predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval1/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_16_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt16_unfix_0rnn
mkdir -p $SAVE
...
export QMODEL=/n/holyscratch01/rush_lab/Users/yuntian/implicit/0rnn_predicttoken_200kprelayernorm_debugautoregressive/phase1/nolegacy/origdata/interval0/gptsmall/m1/feedp_useargmin_lr5e-5_w0_pw1_minus0_fdiagonal/checkpoint_16_5e-05
export BSZ=32
export A=1
export SAVE=fixedpredicttoken_200kprelayernorm/phase2/nolegacy/origdata/gptmall/m1/interval${INTERVAL}/nornn/feedp_useargmin/e${EPOCHS}_m${MODELSAVE}_legacybest_interval${INTERVAL}_m${M}_w${W}_fixq_f${F}_bestval_argmin_nofixq_normgrad_fixq_ckpt16_unfix_0rnn
mkdir -p $SAVE
