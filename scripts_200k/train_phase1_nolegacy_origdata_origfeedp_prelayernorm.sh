...
export SAVE=200kprelayernorm/phase1/nolegacy_origfeedp/origdata/interval${INTERVAL}/gptsmall/m${M}/lr${LR}_minus${MINUS}_f${F}
mkdir -p $SAVE
...
export SAVE=200kprelayernorm/phase1/nolegacy_origfeedp/origdata/interval${INTERVAL}/gptmedium/m${M}/lr${LR}_minus${MINUS}_f${F}
mkdir -p $SAVE
