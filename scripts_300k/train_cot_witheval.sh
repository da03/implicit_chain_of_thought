...
export LR=5e-5
export BSZ=32
export FOLDER=300kaugmented_math_scaffolding_formula
export MODELSAVE="${MODEL////_}"
export SAVE=300k_baselines/cot_withbrackets/gptsmall
echo $SAVE
mkdir -p $SAVE
...
export FOLDER=300kaugmented_math_scaffolding_formula
export MODELSAVE="${MODEL////_}"
export SAVE=300k_baselines/cot_withbrackets/gptmedium
echo $SAVE
mkdir -p $SAVE
...
export LR=5e-5
export BSZ=32
export FOLDER=nobrackets_300kaugmented_math_scaffolding_formula
export MODELSAVE="${MODEL////_}"
export SAVE=300k_baselines/cot_nobrackets/gptsmall
echo $SAVE
mkdir -p $SAVE
...
export FOLDER=nobrackets_300kaugmented_math_scaffolding_formula
export MODELSAVE="${MODEL////_}"
export SAVE=300k_baselines/cot_nobrackets/gptmedium
echo $SAVE
mkdir -p $SAVE
